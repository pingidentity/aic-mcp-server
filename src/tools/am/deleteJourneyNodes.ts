...
export const deleteJourneyNodesTool = {
  ...
  async toolFunction({ realm, nodes }: { realm: string; nodes: Array<{ nodeType: string; nodeId: string }> }) {
